...
<template>
  ...
  >
    ...
    <Timer
      :is-timer-dialog-open="isTimerDialogOpen"
      :timer-task-name="timerTaskName"
      :timer-project="timerProject"
      :timer-description="timerDescription"
      :projects="projects"
      @update:is-timer-dialog-open="toggleTimerDialog"
